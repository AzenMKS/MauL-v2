...
module.exports = herman = async (herman, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = herman.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "*_〆 αzєии 〆_*","listType": "SINGLE_SELECT","sections": list}}, {})
...
➸ *Sejak* : ${getTime}`
      mentions(cptl, x, true)
       ...
       case 'donasi':
               ...
               buttons = [{buttonId: '!gopay',buttonText:{displayText: 'GOOPAY'},type:1},{buttonId:'!pulsa',buttonText:{displayText:'QRIS'},type:1}]
        ...
        case 'creator':
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: 'Jangan Gangu Owner ku !!',
               buttons: buttons,
               headerType: 1
}
...
└────────────>
   ├❒𝐼𝑁𝐹𝑂 𝐵𝑂𝑇
   ├• *Nama : *AghnyChan*
   ├• *Nomer Bot :* @6285643472795 
   ├• *Nomor Owner :* @62895416489526
   ├• *Owner : Azen Ganz*
...
╰┬———╯          │ ∴°·
 ☆\ˍˍ\_ˍ|—|ˍˍ/ˍˍ/∴☆.`
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'ALL MENU'},type:1},{buttonId: `${prefix}rules`,buttonText:{displayText: 'RULES'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '*_〆 αzєии 〆_*', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
🎉🎊🥳🎊🎉🥳🎊🎉🥳🎊🎉🥳`
               ...
               buttonsMessage = {
               contentText: `${man}`,
               footerText: '*_〆 αzєии 〆_*', mageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
        ...
        case 'command':
               ...
               listmenuu = [`[🥳]Menu Tahun`,`[🧸]Menu Group`,`[🐥]Wibu Menu`,`[🤡]Sticker Menu`,`[👳]Islam Menu`,`[🕵️]Serti Menu`,`[☂️]Cerita Menu`,`[📦]Maker Menu`,`[🔞]Dewasa Menu`,`[🛂]Owner Menu`,`[🎮]Game Menu`,`[🎣]Fun Menu`,`[📂]Downloader`,`[📰]Info Menu`,`[🪀]MenuLainnya`,`[🦞]Tools Menu`,`[🤖]Info Bot`,`[🐻]Owner`,`[🐛]Stiker Menu`,`[☕]Dowload Menu`,`[🎉]Owner Menu`,`[📝]Nulis Menu`,`[📊]Game Menu`,`[⏰]Grup Menu`,`[☣️]Wibu Menu`]
               nombor = 1
               startnum = 0
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://telegra.ph/file/0fb8008388847d2c9870e.jpg'
              teksnya = `*[ PRICE LIST ]*
*Sewa Bot* *_〆 αzєии 〆_*
*1 minggu :* 4K
*1 Bulan :* 6K
*5 Bulan :* 7K
...
case 'tiktok':
              ...
              imageMsg = (await herman.prepareMessageMedia(fs.readFileSync(`./media/herman3.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/herman3.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt Maul Botz\n Helpme tu 1k subscriber', imageMessage: imageMsg,
...
"caption": "https://chat.whatsapp.com/HpHQiTyXxncBxtxHa1j0lC",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://instagram.com/_aryagz?utm_medium=copy_link`)
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/HpHQiTyXxncBxtxHa1j0lC')
             break
      case 'ownermenu':
